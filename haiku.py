...
five = ["the cold is coming","invincible you","leaves are falling down","girls who code is fun","coding is useful","how are you doing","i like to play sports","i like to draw things","the subway is slow","scratch is annoying","i am so hungry","the bank stores money","code is colorful","you are beautiful","lets play mafia", "do you want to hang","ella is the god"]
